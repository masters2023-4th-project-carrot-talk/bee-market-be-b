...
class QueryProductRepositoryImplTest extends IntegrationTestSupport {
	...
	void findByLocationIdAndCategoryIdSliceWithOneProduct() {
		...
		assertAll(
			...
			() -> assertThat(product1.getName()).isEqualTo(product.getProductDetails().getTitle()),
	...
	void findByLocationIdAndCategoryIdSliceWithTwoProduct() {
		...
		assertAll(
			...
			() -> assertThat(mainPageSliceDto1.getName()).isEqualTo(product1.getProductDetails().getTitle()),
			...
			() -> assertThat(mainPageSliceDto2.getName()).isEqualTo(product2.getProductDetails().getTitle()),
